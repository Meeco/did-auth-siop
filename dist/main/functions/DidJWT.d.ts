...
import { JWTDecoded, JWTHeader, JWTOptions, JWTPayload, JWTVerifyOptions } from '../../did-jwt-fork/JWT';
import { JWT } from '../types';
import { AuthenticationRequestOpts, AuthenticationRequestPayload, AuthenticationResponseOpts, AuthenticationResponsePayload } from '../types/SIOP.types';
/**
 ...
 */
export declare function verifyDidJWT(jwt: string, resolver: Resolvable, options: JWTVerifyOptions): Promise<JWT.VerifiedJWT>;
/**
...
export declare function signDidJwtPayload(payload: AuthenticationRequestPayload | AuthenticationResponsePayload, opts: AuthenticationRequestOpts | AuthenticationResponseOpts): Promise<string>;
export declare function getAudience(jwt: string): string;
export declare function getIssuerDidFromPayload(payload: JWTPayload, header?: JWTHeader): string;
